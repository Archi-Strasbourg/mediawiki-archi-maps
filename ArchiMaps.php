...
class ArchiMaps
{
    ...
    public static function addScripts(\OutputPage &$out)
    {
        ...
        if (in_array('ext.maps.leaflet', $out->getModules())) {
            ...
            $out->addScriptFile(
                $wgScriptPath.
                '/extensions/ArchiMaps/bower_components/Leaflet.GridLayer.GoogleMutant/Leaflet.GoogleMutant.js'
            );
            $out->addScriptFile(
                $wgScriptPath.
                '/extensions/ArchiMaps/bower_components/leaflet-control-geocoder/dist/Control.Geocoder.js'
            );
            $out->addStyle(
                $wgScriptPath.
                '/extensions/ArchiMaps/bower_components/leaflet-control-geocoder/dist/Control.Geocoder.css'
            );
